...
public class Tasks {
    ...
    public static boolean Task13() {
        ...
        WebElement deliveryCountry = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[6]/div/div/ul/li[47]/a")));
        ...
        return goodCountry.getText().contains("Canada");
    }
}
